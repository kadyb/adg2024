...
# zad 17 Napisz funkcje xy_from_colrow() oraz colrow_from_xy(), które umożliwią transformację 
# kolumn i wierszy na współrzędne geograficzne oraz transformację w drugą stronę. Uwzględnij 
# warunek sprawdzający czy szukane parametry znajdują się w zakresie rastra, tj. nie wychodzą 
# poza jego zasięg.
